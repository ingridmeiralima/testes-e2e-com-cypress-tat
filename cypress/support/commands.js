...
Cypress.Commands.add('fillSignupFormAndSubmit', (email, password) => {
  ...
  cy.contains('button', 'Signup').click()//acha o botão que tem o texto Signup e clica nele
...
Cypress.Commands.add('sessionLogin', (
  ...
  const login = () => cy.guiLogin(user, password)
...
Cypress.Commands.add('editNote', (note, newNoteValue, attachFile = false) => {
  ...
  cy.contains('.list-group-item', note).click()//vai clicar na nota e abrir ela
  cy.wait('@getNote')
  cy.get('#content')
    .as('contentField')
    .clear()
  ...
  //verificando que a nota foi atualizada
...
Cypress.Commands.add('deleteNote', note => {
  ...
  //verificando que a nota foi deletada
